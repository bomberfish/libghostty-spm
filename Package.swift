...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/bomberfish/libghostty-spm/releases/download/storage.1.0.4/GhosttyKit.xcframework.zip",
            checksum: "87069574e9cfb7496c68366b9997fe61c678c790db3eab07d75617145529a146"
        ),
        .testTarget(
            name: "GhosttyKitTest",
