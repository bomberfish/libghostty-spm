...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/bomberfish/libghostty-spm/releases/download/storage.1.0.6/GhosttyKit.xcframework.zip",
            checksum: "694aa754857231e8133d98d572f7981f2e373eacf4767cf37d6c0246694d2719"
        ),
        .testTarget(
            name: "GhosttyKitTest",
