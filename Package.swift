...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/bomberfish/libghostty-spm/releases/download/storage.1.0.0/GhosttyKit.xcframework.zip",
            checksum: "5a78e720710749a894fe6d181e1720b8fa540f3c42ce4ae96adf010c95344846"
        ),
        .testTarget(
            name: "GhosttyKitTest",
