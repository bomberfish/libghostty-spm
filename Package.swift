...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/bomberfish/libghostty-spm/releases/download/storage.1.2.12/GhosttyKit.xcframework.zip",
            checksum: "a17c34e27f9f034b9e2ff266ad1850668ec4fe455dcbb1c8593615f4198302ad"
        ),
        .testTarget(
            name: "GhosttyKitTest",
