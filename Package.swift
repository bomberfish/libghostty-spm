...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/bomberfish/libghostty-spm/releases/download/storage.1.0.5/GhosttyKit.xcframework.zip",
            checksum: "56ca8ee3590ac6682356e2b4424aa6da011918164fb0f0477349f91eeaf658d7"
        ),
        .testTarget(
            name: "GhosttyKitTest",
