...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/bomberfish/libghostty-spm/releases/download/storage.1.2.13/GhosttyKit.xcframework.zip",
            checksum: "25c542dc599608625bb703c51839dfa14b770dc628124d0c681e074292fb68f4"
        ),
        .testTarget(
            name: "GhosttyKitTest",
